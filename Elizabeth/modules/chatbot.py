...
from Alexia import dispatcher, AI_API_KEY, OWNER_ID, SUPPORT_CHAT
import Alexia.modules.sql.chatbot_sql as sql
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows Alexia to talk and provides a more interactive group chat experience.
*Commands:* 
*Admins only:*
